package com.example.aditia.adapter;
...
import com.example.aditia.R;
import com.example.aditia.model.RestaurantItem;
...
public class RestaurantAdapter extends
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_restaurant, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position)
    {
        ...
        tvRestaurantName =
                holder.itemView.findViewById(R.id.tv_restaurant_name);
